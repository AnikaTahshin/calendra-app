...
CREATE INDEX "scheduleIdIndex" ON "scheduleAvailabilities" USING btree ("scheduleId");--> statement-breakpoint
CREATE INDEX "clerkUserIdIndex" ON "event" USING btree ("clerkUserId");